...
public class ChangePasswordView extends CustomComponent {
	...
	private HorizontalLayout buildHorizontalLayout_2() {
		...
		label_3.setValue("Old Password: ");
		horizontalLayout_2.addComponent(label_3);
		
		// passwordField_2
		oldPassword = new PasswordField();
		oldPassword.setImmediate(false);
		oldPassword.setWidth("20.0em");
		oldPassword.setHeight("-1px");
		horizontalLayout_2.addComponent(oldPassword);
		horizontalLayout_2.setExpandRatio(oldPassword, 1.0f);
	...
	private HorizontalLayout buildHorizontalLayout_1() {
		...
		newPassword.setWidth("20.0em");
		newPassword.setHeight("-1px");
		horizontalLayout_1.addComponent(newPassword);
